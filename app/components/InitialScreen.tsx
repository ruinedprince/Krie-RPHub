      ...
      >
        ...
        >
          ...
          <div className="flex justify-end items-start gap-[60px]">
            ...
            <button
              className="w-[32px] h-[24px] bg-transparent leading-none transition-colors ease-in-out duration-300 hover:text-[#bebebe] active:text-[#eeeeee] active:transition-none"
            >
              <svg
